classdef bandit < handle
    ...
    methods
        function obj = bandit(window, textSize, textColour, textWrapat, dotradius, penwidth)
            obj.window = window;
            obj.dotradius = dotradius;
        ...
        function draw(obj,played,forcedchoice)
            ...
            for i = 1:length(numbers)
                DrawFormattedText(window, numbers{i}, ...
                    'center',rect(2,i)+5, obj.textColour,obj.textWrapat,0,0,1,0,rect(:,i)');
            end
            left = obj.left;
            top = obj.top;
            w = obj.w;
